      ...
      return `<div class="factura-card ${pagado ? 'pagada' : 'pendiente'}">
        <div class="factura-main">
          <div class="factura-info">
            ...
            <div class="factura-meta">Nº ${f[COL.nroFac] || '—'} · ${f[COL.local] || '—'}</div>
          </div>
...
// Sobreescribir renderChartsProveedores para usar facturas filtradas
const _renderChartsProveedoresOrig = renderChartsProveedores;
window.renderChartsProveedores = function() {
...
// Poblar meses cuando se carguen los datos
const _loadAllOrig = loadAll;
window.loadAll = async function() {
  await _loadAllOrig.call(this);
  poblarFiltroMes();
};
