...
function toggleTheme() {
  ...
  localStorage.setItem('lharmonie_theme', next);
  // Update theme-color meta
  const meta = document.querySelector('meta[name="theme-color"]');
  if (meta) meta.content = next === 'dark' ? '#141110' : '#F5F0E8';
  // Update toggle icon
...
(function() {
  const saved = localStorage.getItem('lharmonie_theme');
  if (saved === 'dark') {
    document.documentElement.setAttribute('data-theme', 'dark');
    const meta = document.querySelector('meta[name="theme-color"]');
    if (meta) meta.content = '#141110';
