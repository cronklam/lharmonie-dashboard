...
function getAlias(proveedor) {
  if (!proveedor) return '';
  return aliasMap[(proveedor || '').toUpperCase().trim()] || '';
}
...
function renderAlertaDuplicados(dupes) {
  ...
  el.style.cssText = 'display:flex;align-items:center;gap:8px;background:#FBF7F0;border:1px solid rgba(196,168,130,0.4);border-radius:10px;padding:10px 14px;margin:12px 16px 0;';
