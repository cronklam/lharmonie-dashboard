...
function renderAlertaDuplicados(dupes) {
  ...
  el.style.cssText = 'display:flex;align-items:center;gap:8px;background:#F5EFE6;border-left:3px solid #C4A882;border-radius:8px;padding:10px 14px;margin:12px 16px 0;color:#1A0F08;';
